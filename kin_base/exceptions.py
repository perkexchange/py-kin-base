...
from kin_base.horizon_error_codes import *
...
def translate_horizon_error(horizon_error):
    ...
    if horizon_error.type == HorizonErrorType.BAD_REQUEST:
        return RequestError(horizon_error.type, {'invalid_field': horizon_error.extras.get('invalid_field', None)})
